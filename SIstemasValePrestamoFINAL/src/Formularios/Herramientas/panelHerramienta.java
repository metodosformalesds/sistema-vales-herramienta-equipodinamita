...
public class panelHerramienta extends javax.swing.JPanel {

    public panelHerramienta() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Escriba el Num. Inv para Buscar Herramienta:");
        ...
        tblHerramientas.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Numero Inventario", "Nombre", "Cantidad", "Caracteristicas"
            }
        ));
    ...
    public void CargarDatos(String numInv) {

        tabla = new DefaultTableModel(null, tituloColumna);

        try {
            conexion = conexionBD.Conectar();
            String consulta = "SELECT * FROM herramientas WHERE numInventario LIKE" + '"' + numInv + "%" + '"';
            sentencia = conexion.prepareStatement(consulta);
            resultado = sentencia.executeQuery();
