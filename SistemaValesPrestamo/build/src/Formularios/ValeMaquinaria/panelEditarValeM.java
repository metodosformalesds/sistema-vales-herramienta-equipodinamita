...
public class panelEditarValeM extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Editar Vale Maquinaria");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(btnCerrarVale, javax.swing.GroupLayout.PREFERRED_SIZE, 225, javax.swing.GroupLayout.PREFERRED_SIZE))
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(btnCerrarVale, javax.swing.GroupLayout.PREFERRED_SIZE, 56, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addContainerGap())
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ModificarDatos(txtFolio.getText());
        LimpiarFormulario();
        LimpiarBuscador();
    ...
    public void Validacion(){
        ...
        if(txtRecibe.getText().isEmpty() || cmbCondicionFinal.getSelectedItem().equals("Seleccione una opción")){
            btnCerrarVale.setEnabled(false);
        }else{
            btnCerrarVale.setEnabled(true);
        }
    ...
    public void LlenarCampos(String folio){
      ...
      cmbCondicionFinal.setSelectedItem(valeMaquinaria.getCondicionFinal());
    ...
    public void ModificarDatos(String folio){
        ValeMaquinaria valeMaquinaria = new ValeMaquinaria();
        valeMaquinaria.setDocente(txtDocente.getText());
        valeMaquinaria.setMatEntrega(Integer.parseInt(txtEntrega.getText()));
        valeMaquinaria.setNombreSolicitante(txtNomSolicitante.getText());
        valeMaquinaria.setMatriculaSolicitante(Integer.parseInt(txtMatSolicitante.getText()));
        valeMaquinaria.setIdMaquinaria(Integer.parseInt(txtNumSerieMaquina.getText()));
        valeMaquinaria.setCondicionInicial(cmbCondicionInicial.getSelectedItem().toString());
        
        metodoSQL.ModificarDatosvaleM(folio, valeMaquinaria);
    }
    
    public void CerrarValeM(){
        String folio = txtFolio.getText();
        String horaSalida = txtHoraSalida.getText();
        String condicionFinal = cmbCondicionFinal.getSelectedItem().toString();
        int matRecibe = Integer.parseInt(txtRecibe.getText());
        metodoSQL.CerrarValeM(folio, horaSalida, condicionFinal, matRecibe);
    }
